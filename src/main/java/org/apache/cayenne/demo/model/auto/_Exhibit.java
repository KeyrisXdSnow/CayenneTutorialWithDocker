...
public abstract class _Exhibit extends BaseDataObject {
    ...
    public static final DateProperty<LocalDateTime> CLOSING_DATE = PropertyFactory.createDate("closingDate", LocalDateTime.class);
    public static final DateProperty<LocalDateTime> OPENING_DATE = PropertyFactory.createDate("openingDate", LocalDateTime.class);
